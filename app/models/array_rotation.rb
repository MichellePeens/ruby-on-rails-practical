class ArrayRotation < CodeProblem
  ...
  #     A = [3, 8, 9, 7, 6]
  #     K = 3
  # the function should return [9, 7, 6, 3, 8]. With these three rotations were made:
  # [3, 8, 9, 7, 6] -> [6, 3, 8, 9, 7]
  # [6, 3, 8, 9, 7] -> [7, 6, 3, 8, 9]
  # [7, 6, 3, 8, 9] -> [9, 7, 6, 3, 8]
  #
  ...
  #
  # Assume that:
  #     N and K are integers within the range [0..100] and
